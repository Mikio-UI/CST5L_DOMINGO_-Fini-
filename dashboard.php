...
<header class="topbar">
    ...
    <ul class="topbar-nav">
        ...
        <li>
            <a href="/shell.php?page=mytasks" target="_top">
        ...
        <li>
            <a href="/shell.php?page=calendar" target="_top">
        ...
        <li>
            <a href="/shell.php?page=analytics" target="_top">
                ...
                <li>
            <a href="/shell.php?page=melodie" target="_top">
        ...
        <li>
            <a href="/shell.php?page=settings" target="_top">
    ...
    <a href="/shell.php?page=settings" target="_top" class="topbar-user" title="My Profile" style="text-decoration:none;cursor:pointer;">
